const results = [
  [
    ...
    "./splash-results/basketball_thumbnail.png",
  ],
  [
    "Bike",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/bike.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/bike_thumbnail.png",
  ],
  [
    "Cooking",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/cooking.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/cooking_thumbnail.png",
  ],
  [
    "Covid",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/covid.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/covid_thumbnail.png",
  ],
  [
    "Dance",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/dance.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/dance_thumbnail.png",
  ],
  [
    "Basketball_2",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/basketball_2.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/basketball_2_thumbnail.png",
  ],
  [
    "Badminton",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/badminton.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/badminton_thumbnail.png",
  ],
  [
    "Tagging",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/tagging.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/tagging_thumbnail.png",
  ],
  [
    "Lego",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/lego.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/lego_thumbnail.png",
  ],
  [
    "Tennis",
    [
      "/viser-embed/",
      "?playbackPath=/splash-results/tennis.viser",
      // "&synchronizedVideoOverlay=/splash-results/feb28_coffeemachine.mp4",
      // "&synchronizedVideoTimeOffset=-0.05",
    ...
    "./splash-results/tennis_thumbnail.png",
  ],
];
